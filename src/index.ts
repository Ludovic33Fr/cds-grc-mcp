...
server.tool(
  "ProductList",
  "List products with filtering, sorting, and pagination. Returns products respecting visibility rules based on createdBySeller flag.",
  {
    filters: z.object({
...
server.tool(
  "ProductGet",
  "Get a single product by GTIN. Returns product respecting visibility rules based on createdBySeller flag.",
  {
...
server.tool(
  "ProductGetVariants",
  "Get product variants by group reference with pagination. Returns products respecting visibility rules.",
  {
